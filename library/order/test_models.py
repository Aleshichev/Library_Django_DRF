...
class TestOrderModel(TestCase):
    ...
    def setUp(self):
        ...
        time_mock = datetime.datetime(2023, 4, 10, 12, 00, tzinfo=pytz.utc)
    ...
    def test__str__end_at_is_None(self):
        ...
        order_to_expect = "id: 101--- fname lname --- book1"
    ...
    def test__str__end_at_is_not_None(self):
        ...
        order_to_expect = "'id': 103, 'user': CustomUser(id=111), 'book': Book(id=103), 'created_at': '2023-04-10 12:00:00+00:00', 'end_at': '2023-04-25 12:00:00+00:00', 'plated_end_at': '2023-04-10 12:00:00+00:00'"
