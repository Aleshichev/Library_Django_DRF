...
class LoginTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        time.sleep(2)
        login_button = self.driver.find_element(By.XPATH, "/html/body/a[1]")
        login_button.click()
        time.sleep(2)
        login_button = self.driver.find_element(By.XPATH, "/html/body/form/button")
        login_button.click()
        time.sleep(2)
    ...
    def test_successful_logout(self):
        self.login(self.correct_email, self.correct_password)
        logout_button = self.driver.find_element(By.XPATH, "/html/body/a[1]")
        logout_button.click()
        check_text = self.driver.find_element(By.TAG_NAME, "h1").text
        time.sleep(2)
